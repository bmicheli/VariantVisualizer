...
def create_variant_details_accordion(variant):
    ...
    return html.Div([
        ...
        # # ClinVar Details Section (if available)
        # dbc.Row([
        #     dbc.Col([
        #         html.Div([
        #             html.H6([
        #                 html.I(className="fas fa-database me-2"),
        #                 "ClinVar & Prediction Scores"
        #             ], className="text-primary mb-3"),
        ...
        #                     dbc.Col([
        #                         html.Div([
        #                             html.Strong("ClinVar ID: "),
        #                             html.Span(variant.get('clinvar_id', 'N/A'))
        #                         ], className="mb-2"),
                                
        #                         html.Div([
        #                             html.Strong("Disease/Condition: "),
        #                             html.Span(variant.get('clinvar_disease', 'N/A'))
        #                         ], className="mb-2"),
                                
        #                         html.Div([
        #                             html.Strong("Review Status: "),
        #                             html.Span(variant.get('clinvar_review_status', 'N/A'))
        #                         ], className="mb-2")
        #                     ], width=6),
        ...
        #                             html.Span(format_score(variant.get('cadd_score', 0)))
        #                         ], className="mb-2"),
                                
        #                         html.Div([
        #                             html.Strong("SIFT Score: "),
        #                             html.Span(format_score(variant.get('sift_score', 0)))
        #                         ], className="mb-2"),
                                
        #                         html.Div([
        #                             html.Strong("PolyPhen Score: "),
        #                             html.Span(format_score(variant.get('polyphen_score', 0)))
        #                         ], className="mb-2")
        #                     ], width=6)
        #                 ])
        #             ])
        #         ], className="detail-section")
        #     ], width=12)
        # ]) if variant.get('clinvar_sig') or variant.get('cadd_score') else html.Div(),
    ...
    return dbc.Card([
        dbc.CardBody([
            html.Div([
                ...
                dbc.ButtonGroup([
                    dbc.Button("Show All", id="show-all-samples", color="outline-info", size="sm"),
